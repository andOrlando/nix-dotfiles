...
-- Genaral colours
theme.success_fg = "#489568"
theme.loaded_fg  = "#aaaaff"
theme.error_fg = "#fff"
theme.error_bg = "#ff557f"

-- Warning colours
theme.warning_fg = "#ff557f"
...
-- Menu colours
theme.menu_fg                   = "#000"
theme.menu_bg                   = "#e3e2ee"
theme.menu_selected_fg          = "#000"
theme.menu_selected_bg          = "#aaaaff"
theme.menu_title_bg             = "#e3e2ee"
theme.menu_primary_title_fg     = "#000"
theme.menu_secondary_title_fg   = "#000"
...
theme.hint_fg = "#ffffff"
theme.hint_bg = "#489568"
theme.hint_border = "3px solid #489568"
theme.hint_opacity = "0.3"
theme.hint_overlay_bg = "rgba(0,208,135,0.3)"
theme.hint_overlay_border = "2px solid #c6d4d8"
theme.hint_overlay_selected_bg = "rgba(0,179,131,0.2)"
